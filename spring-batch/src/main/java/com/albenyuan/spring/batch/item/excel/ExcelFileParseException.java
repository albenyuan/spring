 ...
 */
package com.albenyuan.spring.batch.item.excel;

import org.springframework.batch.item.ParseException;

/**
 * Exception thrown when parsing org.springframework.batch.item.excel files. The name of the sheet, the row number on that sheet and the
 * name of the org.springframework.batch.item.excel file can be passed in so that in exception handling we can reuse it. This class only has
...
public class ExcelFileParseException extends ParseException {
     ...
     * @param filename  the name of the org.springframework.batch.item.excel file
